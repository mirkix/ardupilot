...
assert(param:add_param(PARAM_TABLE_KEY, 6,  'DCRT_AUTO', 0.0), 'could not add param5')
assert(param:add_param(PARAM_TABLE_KEY, 7,  'BOOST_PCT', 0.0), 'could not add param5')
